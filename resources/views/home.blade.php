                    ...
                    <div class="row wow bounceInLeft">
                        <div class="main_cbrand text-center">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-xs-12">
                                    <div class="cbrand_item m-bottom-2 img">
                                        <img src="/img/client/Unity.png" alt="Unity Link" style="min-height: 30px; max-height: 50px; width:100%"/>
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-12">
                                    <div class="cbrand_item m-bottom-2 img">
                                        <img src="/img/client/UGCCU.png" alt="UGCCU" style="min-height: 30px; max-height: 50px; width:100%"/>
                                    </div>
                                </div>
                            </div>
                        </div>
